...
%"struct.std::array.0" = type { [3 x i64] }
...
define void @_Z19compile_user_facingm(%"struct.std::array"* noalias sret %agg.result, i64 %target) #0 {
  ...
  %xxxxx = alloca %"struct.std::array.0", align 8
  %y = alloca i64, align 8
  store i64 %target, i64* %1, align 8
  %2 = bitcast %"struct.std::array.0"* %xxxxx to i8*
  call void @llvm.memset.p0i8.i64(i8* %2, i8 0, i64 24, i32 8, i1 false)
  %3 = bitcast %"struct.std::array"* %agg.result to i8*
  call void @llvm.memset.p0i8.i64(i8* %3, i8 0, i64 40, i32 8, i1 false)
  %4 = call dereferenceable(8) i64* @_ZNSt5arrayImLm5EEixEm(%"struct.std::array"* %agg.result, i64 1) #1
  %5 = load i64, i64* %4
...
; Function Attrs: nounwind uwtable
define linkonce_odr dereferenceable(8) i64* @_ZNSt5arrayImLm5EEixEm(%"struct.std::array"* %this, i64 %__n) #0 comdat align 2 {
